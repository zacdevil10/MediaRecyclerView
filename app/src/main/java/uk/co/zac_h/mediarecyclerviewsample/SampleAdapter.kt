...
import uk.co.zac_h.mediarecyclerview.MediaRecyclerView

class SampleAdapter(private val context: Context?, private val media: ArrayList<MediaModel>) : RecyclerView.Adapter<SampleAdapter.ViewHolder>() {
