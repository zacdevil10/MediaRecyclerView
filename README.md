...
```xml
<uk.co.zac_h.mediarecyclerview.MediaRecyclerView
...
//MediaRecyclerView accepts image urls as ArrayList<String> and will currently display no more than 4 images
